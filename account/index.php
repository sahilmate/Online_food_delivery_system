...
<body>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2024 <a class="grey-text text-lighten-4" href="#" target="_blank">Group 7</a> All rights reserved.</span>
        <span class="right"> Designed and Developed by <a class="grey-text text-lighten-4" href="#">Group 7</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
